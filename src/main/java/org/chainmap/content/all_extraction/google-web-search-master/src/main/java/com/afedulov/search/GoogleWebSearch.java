...
public class GoogleWebSearch {
  ...
  //private Logger log = LoggerFactory.getLogger(GoogleWebSearch.class);
  ...
  public static class SearchConfig {
    ...
    public String getGoogleSearchUrl(){
      return  GOOGLE_SEARCH_URL_PREFIX + "q=" + PLHD_QUERY + PLHD_RESULTS_NUM + PLHD_SITE + "&tbm=nws";
    }

	public void setGOOGLE_SEARCH_URL_PREFIX(String string) {
		GOOGLE_SEARCH_URL_PREFIX = string;
